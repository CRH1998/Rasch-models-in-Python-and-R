...
data_clean_poly <- data %>% na.omit %>% mutate(Q1 = as.integer(Q1),
                               Q2 = as.integer(Q2),
                               Q3 = as.integer(Q3),
                               Q4 = as.integer(Q4),
                               Q5 = as.integer(Q5),
...
# Fit Rasch model
rasch_model <- PCM(data_clean_poly, sum0 = FALSE)
summary(rasch_model)
```


```{r}
iarm::item_restscore(rasch_model)
```



```{r}
person.parameter(rasch_model)
```
